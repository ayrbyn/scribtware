        ...
        {PROCESS_STEPS.map((step, idx) => {
          ...
          return (
            <React.Fragment key={idx}>
              <Reveal delay={idx * 120} className="group flex flex-col items-center text-center flex-1 px-4">
                ...
                <p className="text-xs font-black text-teal-400 tracking-[0.2em] uppercase mb-2">{step.number}</p>
                <h3 className="font-extrabold text-slate-800 text-lg leading-snug mb-2.5 group-hover:text-teal-600 transition-colors duration-300">{step.title}</h3>
