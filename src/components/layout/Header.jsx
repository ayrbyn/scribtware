...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-[background,padding,box-shadow] duration-300 ${isScrolled ? 'bg-white/95 md:bg-white/90 md:backdrop-blur-md shadow-sm border-b border-slate-100 py-3' : 'bg-transparent py-5'}`}>
